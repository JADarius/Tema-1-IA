...
values_easy = [ida_solver_easy.explored_states, beam_search_solver_easy.explored_states]
values_medium = [ida_solver_medium.explored_states, beam_search_solver_medium.explored_states]
values_hard = [ida_solver_hard.explored_states, beam_search_solver_hard.explored_states]
...
ax3.set_ylabel("Explored states")
ax3.grid(axis='y', linestyle='--', alpha=0.6)

plt.suptitle("Explored states", fontsize=14)
plt.tight_layout()
